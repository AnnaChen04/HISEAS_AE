...
\author{Anna Chen}
\date{Last Updated on November 19, 2025}
...
\begin{enumerate}
    ...
    \item Visualize the error $\textbf{R}_t$ at each time-step at each of the proxy locations by a bubble graph animation across 115.0-130.0 Kya.
